...
function Particle(x,y){
  ...
  this.hue=random(hue-20,hue+20); this.brightness=random(50,80); this.alpha=1;
...
window.onload = function(){
  ...
  function init(){ box.addEventListener("click", openBoxHandler, false); }

  function stepClass(step){ merrywrap.className='merrywrap step-'+step; }

  function openBoxHandler(){
    box.removeEventListener("click", openBoxHandler,false);
    openBox();
  }
